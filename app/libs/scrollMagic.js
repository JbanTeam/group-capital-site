...
!(function (e, t) {
        ...
        F = function () {
          if (m && l && w.inFlow) {
            ...
            w.relSize.width || w.relSize.autoFullWidth
              ...
              w.pushFollowers &&
                ((i['padding' + (t ? 'Top' : 'Left')] = h.duration * g), (i['padding' + (t ? 'Bottom' : 'Right')] = h.duration * (1 - g))),
              R.css(w.spacer, i);
          }
        },
        L = function () {
  ...
  (_.Scene.addOption = function (e, t, n, r) {
    ...
    (_.Event = function (e, t, n, r) {
      ...
      return (
        (this.type = e), (this.target = this.currentTarget = n), (this.namespace = t || ''), (this.timeStamp = this.timestamp = Date.now()), this
      );
    });
