  ...
  var s = function (o, n) {
          ...
          if (!(a.triggerGroup && Math.abs(a.triggerGroup.triggerHook - e) < 1e-4)) {
            ...
            if (a.triggerGroup) {
              if (1 === a.triggerGroup.members.length)
                return (a.triggerGroup.triggerHook = e), void d._indicators.updateTriggerGroupPositions(a.triggerGroup);
              a.triggerGroup.members.splice(a.triggerGroup.members.indexOf(a), 1),
                d._indicators.updateTriggerGroupLabel(a.triggerGroup),
                d._indicators.updateTriggerGroupPositions(a.triggerGroup),
                (a.triggerGroup = void 0);
    ...
    b = {
      start: function (e) {
        ...
        (r.textContent = 'start'),
          v.css(r, { position: 'absolute', overflow: 'visible', 'border-width': 0, 'border-style': 'solid', color: e, 'border-color': e });
      ...
      bounds: function () {
        ...
        return (
          v.css(e, { position: 'absolute', overflow: 'visible', 'white-space': 'nowrap', 'pointer-events': 'none', 'font-size': o }),
          (e.style.zIndex = n),
          e
        );
      },
      trigger: function (e) {
        ...
        var t = document.createElement('div');
        v.css(t, { position: 'absolute', overflow: 'visible', 'border-width': 0, 'border-style': 'solid', color: e, 'border-color': e }),
          t.appendChild(r);
        var i = document.createElement('div');
        return (
          v.css(i, { position: 'fixed', overflow: 'visible', 'white-space': 'nowrap', 'pointer-events': 'none', 'font-size': o }),
          (i.style.zIndex = n),
          i.appendChild(t),
          i
        );
